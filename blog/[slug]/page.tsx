...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      title: post.title,
      description: post.description,
      url: `https://firstsalesociety.com/blog/${post.slug}`,
      siteName: 'First Sale Society',
      publishedTime: post.publishedAt,
      modifiedTime: post.updatedAt || post.publishedAt,
      images: [{ url: 'https://firstsalesociety.com/moduleimages/firstsalesociety.png', width: 1200, height: 630, alt: post.title }],
    },
    twitter: {
...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const blogPostingSchema = {
    ...
    '@type': 'BlogPosting',
    '@id': `https://firstsalesociety.com/blog/${post.slug}#article`,
    headline: post.title,
    description: post.description,
    ...
    author: {
      '@type': 'Person',
      name: 'First Sale Society Operator Team',
      url: 'https://firstsalesociety.com/about',
    ...
    <>
      ...
      <div className="module-content">
        ...
        <div style={{ fontSize: 12.5, color: 'var(--text3)', marginBottom: 16 }}>
          First Sale Society · {new Date(post.publishedAt).toLocaleDateString('en-US', {
            year: 'numeric',
            month: 'long',
            day: 'numeric',
          })}
        ...
        >
          <strong style={{ color: 'var(--heading)' }}>The short version — </strong>
        ...
        {relatedModules.length > 0 && (
          <div style={{ marginTop: 32, paddingTop: 24, borderTop: '1px solid var(--border)' }}>
            <h3>Goes deeper in the curriculum</h3>
            <ul>
