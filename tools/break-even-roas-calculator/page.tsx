...
export const metadata: Metadata = {
  ...
  title: 'Break-Even ROAS Calculator — Know Your Number Before You Spend',
  description:
    'Calculate your exact break-even ROAS. Enter selling price, product cost, shipping, and payment fees — get the minimum ROAS your ads need to hit before you spend a dollar.',
  alternates: { canonical: 'https://firstsalesociety.com/tools/break-even-roas-calculator' },
  openGraph: {
    type: 'website',
    title: 'Break-Even ROAS Calculator — Know Your Number Before You Spend',
    description: 'Calculate your exact break-even ROAS. Enter selling price, cost, shipping, and fees — get the minimum ROAS your ads need to be profitable.',
  ...
  twitter: {
    ...
    title: 'Break-Even ROAS Calculator — Know Your Number Before You Spend',
    description: 'Calculate the minimum ROAS your ads need to break even. Enter your costs, get your number.',
  },
};
  ...
  return (
    <>
      ...
      <div className="module-content">
        ...
        <p>
          Know your number before you spend a dollar. Every kill/scale decision you make compares your actual ROAS to this number — not to a generic benchmark. Calculate it once per product. Use it every day.
        </p>
        <ROASCalculator />
        ...
        <div style={{ marginTop: 32, paddingTop: 24, borderTop: '1px solid var(--border)' }}>
          <h3>Related Operator Questions</h3>
          <ul>
            {relatedFaqSlugs.map((slug) => (
              <li key={slug}>
                <Link href={`/faq/${slug}`}>
                  {slug.replace(/-/g, ' ').replace(/^(.)/, (c) => c.toUpperCase()).replace(/i/g, 'I')} →
                </Link>
              </li>
            ))}
          </ul>
