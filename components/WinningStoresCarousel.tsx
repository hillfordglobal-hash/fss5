 ...
 *
 * Images live at /css/winningstores/N.jpeg (public/css/winningstores/).
 */

type Store = { src: string; stat: string; sub: string };

const stores: Store[] = [
  { src: '/css/winningstores/1.jpeg', stat: 'This store went from 0 monthly visitors to 51k', sub: 'Running 1.1k Facebook ads' },
  { src: '/css/winningstores/2.jpeg', stat: 'This store went from nothing to 29k monthly visitors', sub: 'Running 179 Facebook ads' },
  { src: '/css/winningstores/3.jpeg', stat: 'This store went from nothing to 30k monthly visitors in one month', sub: 'Running 172 Facebook ads' },
  { src: '/css/winningstores/4.jpeg', stat: 'This new store went from nothing to 45k monthly visitors in one month', sub: 'Running 199 Facebook ads' },
  { src: '/css/winningstores/6.jpeg', stat: 'This new store went from 0 to 18k monthly visitors', sub: 'Running 262 Facebook ads' },
  { src: '/css/winningstores/5.jpeg', stat: 'This new store went from nothing to 14k monthly visitors in one month', sub: 'Running 251 Facebook ads' },
  { src: '/css/winningstores/7.jpeg', stat: 'This new store went from nothing to 14k monthly visitors in one month', sub: 'Running 96 Facebook ads' },
  { src: '/css/winningstores/8.jpeg', stat: 'This store went from nothing to 73k monthly visitors in 2 months', sub: 'While running 813 Meta ads' },
];
