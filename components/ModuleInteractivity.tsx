...
export default function ModuleInteractivity() {
  useEffect(() => {
    ...
    if (!lb) {
      ...
      closeBtn.id = 'fss-lightbox-close';
      closeBtn.setAttribute('aria-label', 'Close image');
      closeBtn.innerHTML = '&times;';
      closeBtn.style.cssText =
        'position:fixed;top:calc(env(safe-area-inset-top,0px) + 16px);right:16px;width:44px;height:44px;' +
        'border-radius:50%;border:none;background:rgba(255,255,255,0.16);color:#fff;font-size:26px;line-height:1;' +
