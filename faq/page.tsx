...
export const metadata: Metadata = {
  title: 'Dropshipping FAQ — 79 Operator Questions, Specific Answers',
  description:
    '79 real dropshipping questions with specific, operational answers — Meta ad spend, product validation, ROAS, kill/scale decisions, chargebacks, supplier transitions, and more.',
  alternates: { canonical: 'https://firstsalesociety.com/faq' },
  openGraph: {
    type: 'website',
    title: 'Dropshipping FAQ — 79 Operator Questions, Specific Answers',
    description: '79 real dropshipping questions with specific operational answers — Meta ads, product validation, ROAS, supplier sourcing, legal setup, and more.',
    url: 'https://firstsalesociety.com/faq',
    siteName: 'First Sale Society',
    images: [{ url: 'https://firstsalesociety.com/moduleimages/firstsalesociety.png', width: 1200, height: 630, alt: 'First Sale Society — Dropshipping FAQ' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Dropshipping FAQ — 79 Operator Questions, Specific Answers',
    description: '79 real dropshipping questions with specific operational answers — Meta ads, ROAS, product validation, sourcing, and more.',
  ...
  return (
    <>
      ...
      <div className="hero stage2">
        <div className="hero-eyebrow">Operator FAQ</div>
        <h1>
          {faqItems.length} Operator Questions.<br />
          <em>Specific Answers.</em>
        </h1>
        <p className="hero-sub">
          Every question here came from real community conversations — pulled from discussions where operators were stuck, confused, or had just made an expensive mistake.
        </p>
        <div className="hero-meta">
          <div className="hero-stat">
            <b className="hsv">{faqItems.length}</b>
            <span className="hsl">Operator questions</span>
          </div>
          <div className="hero-stat">
