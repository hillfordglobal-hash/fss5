// AUTO-GENERATED by scripts/build-glossary-data.js — do not hand-edit.
// Source: the glossary-page panel in 09-resources.html (.gloss-page-item blocks).
// definitionHTML is extracted verbatim from the source; definitionText is a
// plain-text version (tags stripped) for use in meta descriptions / teasers.
