...
export interface ToolData {
  ...
  /** FAQ slugs that directly relate to this tool's use case */
  relatedFaqs?: string[];
}
...
export const toolsData: ToolData[] = [
  // ── 1. Profit Margin Calculator ──────────────────────────────────────────
  {
    ...
    metaDescription:
      'Free profit margin calculator. Enter product cost and selling price to get your gross margin %, markup %, and profit per order instantly.',
    ...
    offer: LUXURY_OFFER,
    features: ['Gross margin % calculation', 'Markup % calculation', 'Profit per order', 'Real-time computation', 'No account needed'],
    datePublished: '2026-02-01',
    relatedFaqs: ["my-roas-looks-great-but-im-not-profitable-whats-happening", "im-at-break-even-roas-but-cant-get-profitable-what", "my-supplier-increased-prices-how-do-i-know-when-to"],
  },
  ...
  // ── 2. Dropshipping Profit Calculator ────────────────────────────────────
  {
    ...
    metaDescription:
      'Free dropshipping profit calculator. Enter price, product cost, ad cost per order, and fees to see your real net profit and margin per order.',
    ...
    offer: CJ_OFFER,
    features: ['Net profit per order', 'Net margin %', 'Profit per 100 orders', 'Accounts for ads + fees', 'No account needed'],
    datePublished: '2026-02-01',
    relatedFaqs: ["how-much-money-do-i-actually-need-to-start-dropshipping", "my-supplier-increased-prices-how-do-i-know-when-to"],
  },
  ...
  // ── 3. Product Pricing Calculator ────────────────────────────────────────
  {
    ...
    metaDescription:
      'Free product pricing calculator. Enter your cost and target margin to get the exact selling price, markup, and profit per order. Built for dropshipping.',
    ...
    offer: CJ_OFFER,
    features: ['Target-margin pricing', 'Markup multiple', 'Profit per order', 'Real-time computation', 'No account needed'],
    datePublished: '2026-02-01',
    relatedFaqs: ["should-i-offer-free-shipping-or-charge-for-it-what", "my-supplier-increased-prices-how-do-i-know-when-to"],
  },
  ...
  // ── 4. Shopify Fee Calculator ────────────────────────────────────────────
  {
    ...
    offer: LUXURY_OFFER,
    features: ['Fee per order', 'Net payout', 'Fee as % of order', 'Custom rate + flat fee', 'No account needed'],
    datePublished: '2026-02-01',
  },
  ...
  // ── 5. Conversion Rate Calculator ────────────────────────────────────────
  {
    ...
    offer: LUXURY_OFFER,
    features: ['Conversion rate %', 'Revenue calculation', 'Revenue at 3% CVR', 'Optional AOV input', 'No account needed'],
    datePublished: '2026-02-01',
    relatedFaqs: ["i-have-atcs-but-zero-purchases-my-product-page-looks", "i-have-good-ctr-but-terrible-cvr-on-my-store", "my-conversion-rate-dropped-for-no-apparent-reason-what-usually"],
  },
  ...
  // ── 7. Target ROAS Calculator ────────────────────────────────────────────
  {
    ...
    offer: LUXURY_OFFER,
    features: ['Target ROAS calculation', 'Break-even ROAS', 'Max ad spend per sale', 'Profit-goal based', 'No account needed'],
    datePublished: '2026-02-08',
    relatedFaqs: ["i-have-purchases-but-my-roas-looks-different-in-meta", "i-scaled-too-aggressively-and-now-my-roas-has-crashed"],
  },
  ...
  // ── 8. Break-Even CPA Calculator ─────────────────────────────────────────
  {
    ...
    metaDescription:
      'Free break-even CPA calculator. Enter price, product cost, and fees to find the maximum cost per acquisition you can pay before a sale loses money.',
    ...
    offer: LUXURY_OFFER,
    features: ['Break-even CPA', 'CPA for 20% margin', 'Gross profit per order', 'Custom fees', 'No account needed'],
    datePublished: '2026-02-08',
    relatedFaqs: ["how-do-i-know-if-my-cpa-is-acceptable-when", "when-exactly-should-i-kill-a-product-vs-kill-a"],
  },
  ...
  // ── 9. CPM / CTR / CPC Calculator ────────────────────────────────────────
  {
    ...
    metaDescription:
      'Free CPM calculator for Meta and TikTok ads. Enter spend, impressions, and clicks to get CPM, CPC, and CTR instantly. Built for dropshipping ad analysis.',
    ...
    offer: LUXURY_OFFER,
    features: ['CPM calculation', 'CPC calculation', 'CTR calculation', 'Single-view ad metrics', 'No account needed'],
    datePublished: '2026-02-08',
    relatedFaqs: ["my-cpm-spiked-overnight-did-i-do-something-wrong", "my-frequency-is-going-above-3-should-i-be-worried", "whats-a-healthy-hook-rate-and-why-does-it-matter"],
  },
  ...
  // ── 10. Ad Testing Budget Calculator ─────────────────────────────────────
  {
    ...
    metaDescription:
      'Free dropshipping ad budget calculator. Enter products, daily budget, and test length to see your total testing budget and runway before you start spending.',
    ...
    offer: LUXURY_OFFER,
    features: ['Total test budget', 'Per-product budget', 'Daily spend', 'Test-runway planning', 'No account needed'],
    datePublished: '2026-02-08',
    relatedFaqs: ["abo-or-cbo-for-testing-the-community-cant-agree-and", "how-much-money-do-i-actually-need-to-start-dropshipping"],
  },
  ...
  // ── 11. Customer Lifetime Value (LTV) Calculator ─────────────────────────
  {
    ...
    metaDescription:
      'Free customer lifetime value calculator. Enter AOV, margin, purchase frequency, and lifespan to get LTV, lifetime profit, and your maximum CAC.',
    ...
    offer: LUXURY_OFFER,
    features: ['Lifetime value', 'Lifetime profit', 'Maximum CAC', 'Margin-aware', 'No account needed'],
    datePublished: '2026-02-15',
    relatedFaqs: ["whats-a-good-abandoned-cart-recovery-rate-and-how-do", "when-should-i-set-up-email-flows-im-not-at"],
  },
  ...
  // ── 12. Ecommerce Cash-Flow Calculator ───────────────────────────────────
  {
    ...
    metaTitle: 'Ecommerce Cash Flow Calculator — Working Capital Gap Tool',
    metaDescription:
      'Free ecommerce cash flow calculator. Enter daily ad spend, product cost, and payout delay to see the working capital you need to bridge the gap.',
    ...
    offer: LUXURY_OFFER,
    features: ['Working capital needed', 'Daily cash out', 'Payout-gap float', 'Scaling-aware', 'No account needed'],
    datePublished: '2026-02-15',
    relatedFaqs: ["im-profitable-but-running-out-of-cash-to-scale-how"],
  },
  ...
  // ── 13. Dropshipping Scaling Calculator ──────────────────────────────────
  {
    ...
    offer: LUXURY_OFFER,
    features: ['Projected daily revenue', 'Projected monthly revenue', 'Current vs scaled', 'ROAS reality check', 'No account needed'],
    datePublished: '2026-02-15',
    relatedFaqs: ["i-scaled-too-aggressively-and-now-my-roas-has-crashed", "my-product-is-profitable-at-100-day-every-time-i"],
  },
  ...
  // ── 6. Average Order Value Calculator ────────────────────────────────────
  {
    ...
    metaDescription:
      'Free average order value calculator. Enter revenue and orders to get your AOV, then model the lift from an upsell or bundle. Built for dropshipping.',
    ...
    offer: LUXURY_OFFER,
    features: ['Average order value', 'AOV with upsell', 'Extra revenue per 100 orders', 'Bundle modelling', 'No account needed'],
    datePublished: '2026-02-01',
    relatedFaqs: ["whats-a-good-abandoned-cart-recovery-rate-and-how-do", "should-i-offer-free-shipping-or-charge-for-it-what"],
  },
  ...
  // ── 14. Winning Product Scorecard ────────────────────────────────────────
  {
    ...
    metaTitle: 'Winning Product Scorecard — Dropshipping Product Evaluation Tool',
    metaDescription:
      'Free winning product scorecard for dropshipping. Score any product against the 5 criteria that predict a winner before you spend on ads. Interactive.',
    ...
    offer: LUXURY_OFFER,
    features: ['5-criteria scoring', 'Instant verdict', 'Course-aligned criteria', 'Interactive', 'No account needed'],
  ...
  // ── 15. UTM Builder ──────────────────────────────────────────────────────
  {
    ...
    metaTitle: 'UTM Builder — Campaign URL Tracking Link Generator',
    metaDescription:
      'Free UTM builder. Generate tagged tracking URLs for your ads and campaigns with utm_source, medium, campaign, term, and content. Runs in your browser.',
    keyword: 'utm builder',
    h1: 'UTM Link Builder',
    intro:
    ...
    offer: LUXURY_OFFER,
    features: ['utm_source / medium / campaign', 'Optional term + content', 'One-click copy', 'Runs in-browser', 'No account needed'],
    datePublished: '2026-02-22',
  },
  ...
  // ── 16. Sales Tax Calculator ─────────────────────────────────────────────
  {
    ...
    metaTitle: 'Sales Tax Calculator — Ecommerce Sales Tax & VAT Tool',
    metaDescription:
    ...
    offer: LUXURY_OFFER,
    features: ['Tax amount', 'Total with tax', 'Tax-inclusive extraction', 'Any rate', 'No account needed'],
    datePublished: '2026-02-22',
  },
  ...
  // ── 17. Niche Idea Generator ─────────────────────────────────────────────
  {
    ...
    metaTitle: 'Dropshipping Niche Idea Generator — Filter by Margin & Saturation',
    metaDescription:
      'Free dropshipping niche idea generator. Filter a curated list of niche angles by margin potential, saturation, and evergreen demand to find a starting point.',
    ...
    offer: LUXURY_OFFER,
    features: ['Curated niche angles', 'Filter by margin & saturation', 'Evergreen filter', 'Regenerate', 'No account needed'],
    datePublished: '2026-02-22',
  },
  ...
  // ── 18. MER Calculator ────────────────────────────────────────────────────
  {
    ...
    category: 'Ad Metrics',
    emoji: '📊',
    navName: 'MER Calculator',
    navDesc: 'Calculate your blended Marketing Efficiency Ratio across all channels',
    metaTitle: 'MER Calculator — Free Marketing Efficiency Ratio Tool for Ecommerce',
    metaDescription:
      'Free MER calculator. Enter total revenue and total ad spend across all channels to get your Marketing Efficiency Ratio — a more honest profitability metric than single-channel ROAS.',
    keyword: 'marketing efficiency ratio calculator',
    h1: 'Marketing Efficiency Ratio (MER) Calculator',
    intro:
      'Calculate your blended MER — the total revenue you generate for every dollar spent on marketing across all channels. More honest than single-channel ROAS because it accounts for your full marketing picture.',
    steps: [
      { name: 'Enter your total revenue', text: 'Your revenue from all sources — Shopify, any other channels — for the period.' },
      { name: 'Enter your total ad spend', text: 'All marketing spend across all channels — Meta, TikTok, Google, influencers, anything.' },
      { name: 'Read your MER', text: 'The calculator shows your blended ratio and what percentage of revenue is going back into marketing.' },
    ],
    body: [
      'MER (Marketing Efficiency Ratio) is total revenue divided by total ad spend across all channels. Unlike ROAS — which measures one channel against its own attributed revenue — MER captures the full picture, including the revenue that organic, email, and branded search generate as a result of your paid campaigns.',
      'Single-channel ROAS is a useful operational metric for managing individual campaigns. MER is the business-level metric that tells you whether your overall marketing investment is working. Many operators find that their Meta ROAS looks weak but their MER is healthy, because the paid ads are driving organic search and direct traffic that Meta can't attribute.',
      'A healthy MER for a dropshipping business with margins of 40–60% is typically 3× or above. Below 2× usually means marketing is consuming too much of your revenue. Above 5× is excellent but may indicate underinvestment in growth.',
    ],
    faqs: [
      { q: 'What is Marketing Efficiency Ratio?', a: 'MER is total revenue divided by total ad spend across all marketing channels. It measures how much revenue you generate for every dollar you spend on marketing — across your entire business, not just one platform.' },
      { q: 'What is the difference between MER and ROAS?', a: 'ROAS measures one channel's attributed revenue against that channel's spend. MER measures all revenue against all spend. MER is more honest about true business-level efficiency because it captures cross-channel effects that single-platform attribution misses.' },
      { q: 'What is a good MER for dropshipping?', a: 'For a business with 40–60% gross margins, 3× MER or above is healthy. Below 2× means marketing is consuming too much revenue. The right target depends on your margins — calculate your break-even MER the same way you calculate break-even ROAS.' },
      { q: 'Should I use MER or ROAS to make decisions?', a: 'Both — for different things. Use ROAS at the campaign level to optimise individual Meta or TikTok campaigns. Use MER at the business level to evaluate overall marketing efficiency and whether to increase or decrease total marketing investment.' },
    ],
    related: [
      { href: '/glossary/mer', label: 'What is MER? Full definition →' },
      { href: '/tools/break-even-roas-calculator', label: 'Calculate your channel-level break-even →' },
      { href: '/tools/profit-margin-calculator', label: 'Check if MER leaves room for profit →' },
      { href: '/course/read-your-data', label: 'How to read your ad and store data →' },
    ],
    offer: LUXURY_OFFER,
    features: ['MER calculation', 'Blended ad spend %', 'All-channel view', 'No account needed'],
  ...
  // ── 19. CAC Calculator ────────────────────────────────────────────────────
  {
    ...
    category: 'Growth & Retention',
    emoji: '🎯',
    navName: 'CAC Calculator',
    navDesc: 'Calculate your true Customer Acquisition Cost',
    metaTitle: 'CAC Calculator — Free Customer Acquisition Cost Tool',
    metaDescription:
      'Free CAC calculator. Enter total acquisition spend and new customers acquired to get your Customer Acquisition Cost — and compare it against LTV to evaluate sustainability.',
    keyword: 'customer acquisition cost calculator',
    h1: 'Customer Acquisition Cost (CAC) Calculator',
    intro:
      'Calculate your true cost to acquire each new customer and evaluate whether it's sustainable relative to customer lifetime value. The CAC:LTV ratio is one of the most important metrics in scaling a profitable store.',
    steps: [
      { name: 'Enter your total acquisition spend', text: 'All marketing spend that goes toward acquiring new customers — ads, creative production, platform fees.' },
      { name: 'Enter new customers acquired', text: 'The number of first-time customers during the same period.' },
      { name: 'Optionally adjust for organic', text: 'If you have organic traffic, enter the percentage of new customers who came through non-paid channels to get your paid-only CAC.' },
      { name: 'Read your CAC', text: 'Compare to your LTV — a healthy business keeps CAC below one-third of LTV.' },
    ],
    body: [
      'Customer Acquisition Cost is total acquisition spend divided by new customers acquired. At its simplest, if you spent $5,000 on Meta ads this month and acquired 100 new customers, your CAC is $50.',
      'The reason CAC matters at scale is that platform-reported CPA understates your true acquisition cost. It misses creative production costs, tool subscriptions, agency fees, and the spend on campaigns that didn't convert. True CAC includes all of it.',
      'The metric that makes CAC meaningful is LTV (Lifetime Value). A $50 CAC is excellent if a customer is worth $300 over their lifetime. It's unsustainable if they only ever buy once at $45. Use the CLV Calculator alongside this one to see whether your acquisition economics make sense at scale.',
    ],
    faqs: [
      { q: 'What is Customer Acquisition Cost?', a: 'CAC is the total cost to acquire one new customer — total acquisition spend divided by new customers acquired. At scale, it's always higher than single-channel CPA because it includes creative costs, platform fees, and failed campaigns.' },
      { q: 'What is a good CAC?', a: 'CAC is only meaningful relative to LTV. The standard benchmark is CAC:LTV ratio of 1:3 or better — spend $1 to acquire a customer worth $3 over their lifetime. Without LTV context, CAC in isolation doesn't tell you if you're building a profitable business.' },
      { q: 'How is CAC different from CPA?', a: 'CPA (Cost Per Acquisition) is usually a platform metric — what one ad platform reports as cost per purchase. CAC is a business metric — total acquisition spending divided by total new customers, including all channels and all costs.' },
      { q: 'How do I reduce my CAC?', a: 'Improve creative quality (higher CTR reduces CPC), improve your product page CVR (same traffic, more customers), test organic channels to supplement paid, and improve retention so LTV grows — which makes the same CAC more sustainable.' },
    ],
    related: [
      { href: '/glossary/cac', label: 'What is CAC? Full definition →' },
      { href: '/tools/customer-lifetime-value-calculator', label: 'Calculate LTV to evaluate your CAC →' },
      { href: '/tools/break-even-cpa-calculator', label: 'Find your max sustainable CPA →' },
      { href: '/course/scale-your-ads', label: 'How to scale while controlling CAC →' },
    ],
    offer: LUXURY_OFFER,
    features: ['Blended CAC', 'Paid-only CAC', 'Organic adjustment', 'LTV context', 'No account needed'],
    datePublished: '2026-06-28',
  },


  // ── 20. Gross Profit Calculator ───────────────────────────────────────────
  {
    slug: 'gross-profit-calculator',
    category: 'Profit & Pricing',
    emoji: '💰',
    navName: 'Gross Profit Calculator',
    navDesc: 'Calculate gross profit and gross margin from revenue and COGS',
    metaTitle: 'Gross Profit Calculator — Free Ecommerce Gross Margin Tool',
    metaDescription:
      'Free gross profit calculator. Enter revenue and cost of goods sold to get gross profit, gross margin %, and COGS as a percentage of revenue.',
    keyword: 'gross profit calculator',
    h1: 'Gross Profit Calculator',
    intro:
      'Calculate your gross profit and gross margin from revenue and cost of goods sold. Gross profit is the foundation of every other profitability metric — know this number before interpreting ROAS, CPA, or LTV.',
    steps: [
      { name: 'Enter total revenue', text: 'Your total revenue for the period — from Shopify or your chosen time window.' },
      { name: 'Enter COGS', text: 'Total cost of goods sold — product cost, supplier shipping, and payment processing fees for the same period.' },
      { name: 'Read your gross profit and margin', text: 'The calculator shows gross profit in dollars, gross margin as a percentage, and COGS as a percentage of revenue.' },
    ],
    body: [
      'Gross profit is revenue minus cost of goods sold. For a dropshipping business, COGS includes the product cost, shipping from your supplier, and payment processing fees. Everything else — ad spend, Shopify subscription, apps, tools — comes out of gross profit to give you net profit.',
      'Gross margin percentage is gross profit divided by revenue, expressed as a percentage. A 50% gross margin means half your revenue is available to cover ad spend and overhead. For paid traffic to work long-term, most dropshipping operators need a minimum 40% gross margin — thinner than that and the cost of customer acquisition consumes the margin before any profit remains.',
      'Gross profit is not profit. A high ROAS can mask a collapsing gross margin if your COGS is rising. Always calculate gross margin before interpreting ROAS or deciding to scale.',
    ],
    faqs: [
      { q: 'What is gross profit?', a: 'Gross profit is revenue minus cost of goods sold (COGS). It represents what is left after the direct cost of the product before subtracting advertising, overhead, and other operating expenses.' },
      { q: 'What is a good gross margin for dropshipping?', a: 'For paid traffic to work sustainably, most dropshipping operators target 40–65% gross margin. Below 30% leaves little room for ad costs, returns, and tools while still being profitable. Above 65% usually indicates either a premium product or a very low COGS — both good problems to have.' },
      { q: 'What is included in COGS for dropshipping?', a: 'For dropshipping, COGS typically includes: the product cost from your supplier, shipping from supplier to customer, and payment processing fees (Shopify Payments or PayPal). Ad spend is not COGS — it is a marketing expense that comes out of gross profit.' },
      { q: 'How does gross profit relate to break-even ROAS?', a: 'Break-even ROAS is selling price divided by gross profit per order. A higher gross profit per order means a lower break-even ROAS, which means more room for ad inefficiency before you lose money.' },
    ],
    related: [
      { href: '/tools/profit-margin-calculator', label: 'Full profit margin with all fees →' },
      { href: '/tools/break-even-roas-calculator', label: 'Turn gross profit into break-even ROAS →' },
      { href: '/glossary/cogs', label: 'What counts as COGS? →' },
      { href: '/course/validate-the-product', label: 'Using gross margin in product validation →' },
    ],
    relatedFaqs: [
      'my-roas-looks-great-but-im-not-profitable-whats-happening',
      'im-at-break-even-roas-but-cant-get-profitable-what',
      'my-supplier-increased-prices-how-do-i-know-when-to',
    ],
    offer: LUXURY_OFFER,
    features: ['Gross profit', 'Gross margin %', 'COGS %', 'Benchmarks', 'No account needed'],
    datePublished: '2026-06-28',
  },
