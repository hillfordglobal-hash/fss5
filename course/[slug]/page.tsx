...
export default async function ModulePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <>
      ...
      {/* Last Updated — E-E-A-T signal, visible above content */}
      <div style={{ fontSize: 12, color: 'var(--text3)', padding: '0 0 8px', display: 'flex', alignItems: 'center', gap: 8 }}>
        <span>Updated June 2026</span>
        <span style={{ color: 'var(--border)' }}>·</span>
        <span>Written by active ecommerce operators</span>
        <span style={{ color: 'var(--border)' }}>·</span>
        <a href="https://discord.gg/sYwE5Mhw9Z" rel="noopener" target="_blank" style={{ color: 'var(--accent)', textDecoration: 'none' }}>Join the Discord community</a>
      </div>
      ...
      {mod.slug === 'find-winning-products' && (
        <div className="module-content" style={{ paddingTop: 0, paddingBottom: 0 }}>
        ...
        {!hasEmbeddedDiscordCta && (
          ...
          >
            ...
            <div style={{ fontSize: 13, color: 'var(--text2)' }}>
              Ad reviews, store critiques, real feedback from operators running real spend.
            </div>
            <a
