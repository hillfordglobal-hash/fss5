...
export const metadata: Metadata = {
  title: 'Ecommerce Calculators — Break-Even ROAS, Margins, MER, CAC & More',
  description:
    'Ecommerce calculators for operators: break-even ROAS, profit margin, net profit, product pricing, Shopify fees, conversion rate, MER, CAC, AOV and more.',
  alternates: { canonical: `${TOOLS_SITE}/tools` },
  openGraph: {
    type: 'website',
    title: 'Ecommerce Calculators — First Sale Society',
    description:
      'Ecommerce calculators for operators — break-even ROAS, profit margin, net profit, pricing, Shopify fees, conversion rate, MER, CAC, AOV and more.',
    url: `${TOOLS_SITE}/tools`,
    siteName: 'First Sale Society',
    images: [{ url: `${TOOLS_SITE}/moduleimages/firstsalesociety.png`, width: 1200, height: 630, alt: 'Ecommerce Calculators — First Sale Society' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Ecommerce Calculators — Break-Even ROAS, Margins, MER, CAC & More',
    description: 'Break-even ROAS, profit margin, pricing, Shopify fees, conversion rate, MER, CAC, AOV and more. No signup.',
    images: [`${TOOLS_SITE}/moduleimages/firstsalesociety.png`],
  },
};
...
export default function ToolsIndexPage() {
  const itemListSchema = {
    ...
    '@type': 'ItemList',
    name: 'First Sale Society Ecommerce Calculators',
  ...
  return (
    <>
      ...
      <div className="module-content">
        <h1>Ecommerce Calculators</h1>
        <p>
          Calculators for ecommerce operators — break-even ROAS, margins, MER, CAC, cash flow, LTV, and more. Every tool links back to the module that covers the strategy behind the number.
        </p>
        ...
        <p style={{ marginTop: 32, fontSize: 14, color: 'var(--text3)' }}>
          More calculators are added as operators request them. Suggestions go in the{' '}
