...
export const metadata: Metadata = {
  title: 'Best Dropshipping Tools 2026 — The Complete Operator Toolkit',
  description:
    'Best dropshipping tools 2026 — vetted by operators. Covers product research, sourcing, store build, Meta ads, and scaling. Direct links, no affiliate filler.',
