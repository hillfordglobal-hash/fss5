...
export const metadata: Metadata = {
  ...
  description:
    'Free dropshipping course for 2026. Product research, Meta ads, Shopify store building, supplier sourcing, and scaling — taught by active operators. No paywall.',
...
const courseSchema = {
  ...
  description:
    'A free, complete dropshipping course covering product research, Meta ads, Shopify store building, supplier sourcing, and brand building. Written by active ecommerce operators in 2026.',
  ...
  return (
    <>
      ...
      <div className="hero stage1">
        <div className="hero-eyebrow">Free · 2026 · Zero Paywall</div>
        <h1>
          The Complete <em>Ecommerce Operator Library</em>
        </h1>
        <p className="hero-sub">
          The compiled best resource for every aspect of dropshipping and ecommerce — product research,
          Meta ads, store building, creative testing, and scaling. It's the complete operator library: curated
          and written by active operators running real ad spend in 2026.
          The training material ecommerce teams are built on. Free, no paywall.
        </p>
        <div className="hero-meta">
          ...
          <div className="hero-stat">
            <b className="hsv">$0</b>
            <span className="hsl">Cost, always</span>
          </div>
        </div>
      </div>
